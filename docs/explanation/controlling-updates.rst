...
snaps from other publishers (for example, Canonical). There are two general approaches
...
* `Validation Sets <https://snapcraft.io/docs/validation-sets>`_
   ...
   instead of validating snaps one by one.
...
* **Device Agent**
   ...
   For more details, see the `snapd-control interface <https://snapcraft.io/docs/reference/interfaces/snapd-control-interface/>`_.
