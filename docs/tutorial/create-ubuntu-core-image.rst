...
hardware identifier for uniqueness and traceability. See an example `here <https://documentation.ubuntu.com/dedicated-snap-store/how-to/creating-serial-numbers/>`_.
