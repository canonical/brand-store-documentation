...
A Dedicated Snap Store permits the use of hardware / privileged snapd interfaces, and the hosting of gadget and kernel snaps, in addition to providing a
...
This documentation provides links to some key pages, and provides information on some key concepts and processes specific to your Dedicated Snap Store.

.. note:: Please submit a `support ticket <https://portal.support.canonical.com>`_ for additional support.
