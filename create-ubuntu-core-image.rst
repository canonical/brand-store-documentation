...
To build a custom gadget snap, we start by selecting a suitable suitable candidate from the `Canonical supported gadgets <https://snapcraft.io/docs/the-gadget-snap>`_
